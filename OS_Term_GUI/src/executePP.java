...
public class executePP {
    ...
    public void run() {
        ...
        // 결과를 GUI로 표시
        SwingUtilities.invokeLater(() -> new ResultDisplay("Preemptive Priority Scheduling Results", completedProcesses, avgWaitingTime, avgTurnaroundTime, avgResponseTime));
    }
}
